          ...
          <div class="card-body">
             <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input id="input_user_password" value="{{ old('password') }}" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ trans('users.form_control.input.password.placeholder') }}"
